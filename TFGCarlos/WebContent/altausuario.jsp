...
<script
	src="https://www.google.com/recaptcha/api.js?render=6LeKMsEUAAAAAELRrmoYEOzACgQJqHjhWnLMw7z7"></script>
<script>
	grecaptcha.ready(function() {
		grecaptcha.execute('6LeKMsEUAAAAAELRrmoYEOzACgQJqHjhWnLMw7z7', {
			action : 'altaUsuario'
		}).then(
				function(token) {
	...
	<div class="container-fluid">
		...
		<div class="row">
				...
				<div class="row col-6 mx-auto">
					<form action="${pageContext.request.contextPath}/controller"
						...
						<div class="form-group">
							<label for="Email">Correo electónico:</label> <input type="email"
						...
						<a class="btn btn-primary" href="/TFGCarlos/index.jsp">Cancelar</a>
			...
			<c:if test="${requestScope.confirmacion != null}">
				<div id="divconfirmacion" class="centrarTexto mx-auto col-7 mt-2 mb-2">
					<p>
